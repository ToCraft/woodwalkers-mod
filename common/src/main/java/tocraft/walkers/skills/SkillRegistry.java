...
public class SkillRegistry {
    ...
    public static void registerDefault() {
        ...
        registerByTag(TagKey.create(Registry.ENTITY_TYPE_REGISTRY, Walkers.id("burns_in_daylight")), new BurnInDaylightSkill<>());
        registerByTag(TagKey.create(Registry.ENTITY_TYPE_REGISTRY, Walkers.id("flying")), new FlyingSkill<>(false));
        registerByTag(TagKey.create(Registry.ENTITY_TYPE_REGISTRY, Walkers.id("slow_falling")), new SlowFallingSkill<>());
        registerByTag(TagKey.create(Registry.ENTITY_TYPE_REGISTRY, Walkers.id("wolf_prey")), PreySkill.ofHunterClass(Wolf.class));
        registerByTag(TagKey.create(Registry.ENTITY_TYPE_REGISTRY, Walkers.id("fox_prey")), PreySkill.ofHunterClass(Fox.class));
        registerByTag(TagKey.create(Registry.ENTITY_TYPE_REGISTRY, Walkers.id("hurt_by_high_temperature")), new TemperatureSkill<>());
        registerByTag(TagKey.create(Registry.ENTITY_TYPE_REGISTRY, Walkers.id("ravager_riding")), RiderSkill.ofRideableClass(Ravager.class));
        registerByTag(TagKey.create(Registry.ENTITY_TYPE_REGISTRY, Walkers.id("lava_walking")), new StandOnFluidSkill<>(FluidTags.LAVA));
        registerByTag(TagKey.create(Registry.ENTITY_TYPE_REGISTRY, Walkers.id("fall_through_blocks")), new NoPhysicsSkill<>());
        registerByTag(TagKey.create(Registry.ENTITY_TYPE_REGISTRY, Walkers.id("cant_swim")), new CantSwimSkill<>());
        registerByTag(TagKey.create(Registry.ENTITY_TYPE_REGISTRY, Walkers.id("undrownable")), new UndrownableSkill<>());
        // Attack for Health
