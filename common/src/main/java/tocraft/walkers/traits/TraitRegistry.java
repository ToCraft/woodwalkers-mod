...
public class TraitRegistry {
    ...
    public static void registerDefault() {
        ...
        registerByTag(TagKey.create(Registry.ENTITY_TYPE_REGISTRY, Walkers.id("burns_in_daylight")), new BurnInDaylightTrait<>());
        registerByTag(TagKey.create(Registry.ENTITY_TYPE_REGISTRY, Walkers.id("flying")), new FlyingTrait<>(false));
        registerByTag(TagKey.create(Registry.ENTITY_TYPE_REGISTRY, Walkers.id("slow_falling")), new SlowFallingTrait<>());
        registerByTag(TagKey.create(Registry.ENTITY_TYPE_REGISTRY, Walkers.id("wolf_prey")), PreyTrait.ofHunterClass(Wolf.class));
        registerByTag(TagKey.create(Registry.ENTITY_TYPE_REGISTRY, Walkers.id("fox_prey")), PreyTrait.ofHunterClass(Fox.class));
        registerByTag(TagKey.create(Registry.ENTITY_TYPE_REGISTRY, Walkers.id("hurt_by_high_temperature")), new TemperatureTrait<>());
        registerByTag(TagKey.create(Registry.ENTITY_TYPE_REGISTRY, Walkers.id("ravager_riding")), RiderTrait.ofRideableClass(Ravager.class));
        registerByTag(TagKey.create(Registry.ENTITY_TYPE_REGISTRY, Walkers.id("lava_walking")), new StandOnFluidTrait<>(FluidTags.LAVA));
        registerByTag(TagKey.create(Registry.ENTITY_TYPE_REGISTRY, Walkers.id("fall_through_blocks")), new NoPhysicsTrait<>());
        registerByTag(TagKey.create(Registry.ENTITY_TYPE_REGISTRY, Walkers.id("cant_swim")), new CantSwimTrait<>());
        registerByTag(TagKey.create(Registry.ENTITY_TYPE_REGISTRY, Walkers.id("undrownable")), new UndrownableTrait<>());
        // Attack for Health
