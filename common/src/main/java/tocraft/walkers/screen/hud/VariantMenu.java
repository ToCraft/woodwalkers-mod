                ...
                if (currentShapeType != null) {
                    ...
                    if (range > -1) {
                        ...
                        for (int i = 1; i <= 5; i++) {
                            ...
                            if (entity != null) {
                                InventoryScreen.renderEntityInInventory(matrices, (int) ((float) x * i + (float) x / 2), (int) ((float) y * .75f), (int) (25 * (1 / (Math.max(entity.getBbHeight(), entity.getBbWidth())))), new Quaternionf().rotationXYZ(0.43633232F, (float) Math.PI, (float) Math.PI), null, entity);
                            }
                        }
                    } else {
                        LivingEntity entity = currentShapeType.create(level);
                        if (entity != null) {
                            InventoryScreen.renderEntityInInventory(matrices, (int) ((float) x * 3 + (float) x / 2), (int) ((float) y * .75f), (int) (25 * (1 / (Math.max(entity.getBbHeight(), entity.getBbWidth())))), new Quaternionf().rotationXYZ(0.43633232F, (float) Math.PI, (float) Math.PI), null, entity);
                        }
                    }
                    // render focus
